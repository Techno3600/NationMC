...
public class PlayerScoreboardManager
{
	public static void PlayerScoreboard(Player p, String s)
	{
		...
		o.getScore(ChatColor.translateAlternateColorCodes('&', "&8» &eLobby")).setScore(11);
		...
		o.getScore(ChatColor.translateAlternateColorCodes('&', "&8» &ehttps://discord.gg/FvXmtms")).setScore(8);
		...
		o.getScore(ChatColor.translateAlternateColorCodes('&', "&8» &ehttp://www.thenationmc.pro/")).setScore(5);
